vim.cmd [[
    ...
    highlight Constant guifg=#b58900
    highlight String guifg=#2aa198
    highlight Identifier guifg=#268bd2
    highlight Function guifg=#6c71c4
    highlight Statement guifg=#dc322f
    highlight Type guifg=#859900
    highlight PreProc guifg=#cb4b16
    highlight Special guifg=#d33682
]]
